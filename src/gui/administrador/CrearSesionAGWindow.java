...
import gui.controladores.administrador.ControladorCrearSesionAG;

/**
 * Este fichero muestra todo lo que tiene que ver con la clase CrearSesionAGWindow
 *
 ...
 *
 */
public class CrearSesionAGWindow extends JPanel{
	...
	/**
	 * Constructor CrearSesionAGWindow
	 */
	public CrearSesionAGWindow()
	{
		 layout = new SpringLayout();
	        ...
	        /****************************************************************************/
	        etiqueta = new JLabel("CREAR SESION GRUPAL");
    ...
    /**
     * GETTER
     * @return la caja con todoas las salas del gimnasio
     */
     ...
     * @param controladorCrearSesionAG el controlador de la ventana
     */
	public void setControlador(ControladorCrearSesionAG controladorCrearSesionAG) {
		botonCancelar.addActionListener(controladorCrearSesionAG);
		botonHecho.addActionListener(controladorCrearSesionAG);
		
	}
	
	/**
	 * Actualiza la caja con las nuevas salas
	 * @param nuevasSalas las salas que vana a estar en la caja
	 */
